function CustomSizes() {
  return (
    <div className="ml-10 mt-3 -mr-10">
      <ul className="mb-5 ml-4 rounded-xl overflow-hidden ">
        <li className="h-[44px] items-center flex  bg-[#323232] px-4 py-2 shadow-lg">
          Grams (g)
        </li>
      </ul>
      <ul className="rounded-xl overflow-hidden -mt-7 shadowww">
        <li className="h-[44px] items-center flex border-b font-medium border-white/5 bg-[#323232] px-4 py-2 shadow-lg">
