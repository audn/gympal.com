...
function Four() {
  return (
    <main className={'h-full px-6 mt-[80px] sm:mt-0'}>
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-2xl sm:text-5xl font-bold sm:pb-12 leading-10 sm:leading-[65px] ">
            Ever wished for a companion that evolves with your fitness journey?
          </h1>
          <div className="bg-types-100 p-12 mt-5 sm:mt-24 items-center relative rounded-2xl flex justify-between">
            <div className="max-w-xl">
              <h2 className="text-on-100 text-4xl font-medium leading-[52px]">
              ...
              <div className="relative mt-12 max-w-sm flex items-center justify-center">
                <input
                  className="bg-types-200 h-[50px] outline-none w-full border border-[#2C2C2E] rounded-full px-6 py-2"
                  placeholder="Email"
                />
                <div className="absolute right-2">
                  <button className="bg-brand-primary-200 text-black px-4 text-sm flex items-center font-bold py-2 rounded-full">
                    <i className="fa-solid fa-right-to-bracket mr-2" /> Get
                    Early Access
                  </button>
                </div>
              </div>
              <p className="mt-2 ml-3 text-on-100">
                Under development - Not yet available to the public.
              </p>
            </div>
            <div className=" absolute  right-0 hidden lg:flex">
              <Phone source="phone1.png" className="scale-90" />
            </div>
          </div>
          <div className="absolute bottom-12 inset-x-0 flex flex-col items-center text-white/60">
            More Below
            <i className="fa-solid fa-arrow-down text-lg wobble " />
          </div>
        </div>
      </div>
      <div className="min-h-screen flex flex-col space-y-10 pb-24">
        <div className=" max-w-6xl mx-auto">
